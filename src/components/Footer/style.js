...
export const FooterRight = styled.ul`
  ...
  .item {
    ...
    .link {
      ...
      background: url("https://s2.music.126.net/style/web2/img/foot_enter_new.png") no-repeat;
    ...
    .title {
      ...
      background: url("https://s2.music.126.net/style/web2/img/foot_enter_tt.png") no-repeat;
